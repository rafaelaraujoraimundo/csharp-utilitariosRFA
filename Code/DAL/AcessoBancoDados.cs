...
namespace DAL //Namespace da camada de Banco de Dados. Pode ter qualquer nome, no entanto, por padrão chamamos de DAL - Data Access Layer
{
    class AcessoBancoDados
    {
        ...
        private String password = "1234567"; //Senha do usuário para acessar o banco de dados
        private String database = "prosaude"; //Banco de Dados
        ...
        public void Conectar()
        {
            ...
            try
            {
                ...
                conn.Open(); //Invoca o método "Open()" da classe "SqlConnection"
            }
